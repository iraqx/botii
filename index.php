...
$botToken =  "6676354345:AAFe7dtDzNtA-t8BbXVue_-SFAtkhWTOeXE";
...
$free = json_encode($keyboard);
        file_get_contents("https://api.telegram.org/bot6676354345:AAFe7dtDzNtA-t8BbXVue_-SFAtkhWTOeXE/editMessageText?chat_id=$cchatid2&text=$freecommands&message_id=$cmessage_id2&parse_mode=HTML&reply_markup=$free");
...
file_get_contents("https://api.telegram.org/bot6676354345:AAFe7dtDzNtA-t8BbXVue_-SFAtkhWTOeXE/editMessageText?chat_id=$cchatid2&text=$finalize&message_id=$cmessage_id2&parse_mode=HTML");
}
...
$premium_id = (array("5501736438"));
$premiumgp = (array("-1001893485152"));
...
// if(!in_array($chatId, $premiumgp)){
	// $tch = json_decode(file_get_contents("https://api.telegram.org/bot6676354345:AAFe7dtDzNtA-t8BbXVue_-SFAtkhWTOeXE/getChatMember?chat_id=@roldexverse&user_id=".$gId))->result->status;
...
// exit();
// }
        	// $tch = json_decode(file_get_contents("https://api.telegram.org/bot6676354345:AAFe7dtDzNtA-t8BbXVue_-SFAtkhWTOeXE/getChatMember?chat_id=@roldexversechats&user_id=".$gId))->result->status;
// if($tch != 'member' && $tch != 'creator' && $tch != 'administrator'){
// bot('sendMessage',['chat_id'=>$chatId,'reply_to_message_id'=>$message_id,'text'=>"Sorry <a href='tg://user?id=$gId'>$firstname</a>
// 
// You Need To Join My Update Channel To Get Regular Updates
...
function bot($method,$datas=[]){
    $url = "https://api.telegram.org/bot6676354345:AAFe7dtDzNtA-t8BbXVue_-SFAtkhWTOeXE/".$method;
    $ch = curl_init();
...
function sendMessage1($message) {
        ...
        $url = $GLOBALS[website]."/sendMessage?chat_id=-1001893485152&text=".$message."&parse_mode=HTML";
        file_get_contents($url);
